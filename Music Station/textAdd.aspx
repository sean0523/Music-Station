<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="textAdd.aspx.cs" Inherits="Music_Station.textAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br/><br/><br/>
    <h1 style="color:white;">新增歌詞</h1>
    <asp:Label ID="Label1" runat="server" Text="新增歌詞:" style="color:white;"></asp:Label>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
    <br/>
