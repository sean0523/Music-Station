<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="introductionAdd.aspx.cs" Inherits="Music_Station.introductionAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br/><br/><br/>
    <h1 style="color:white;">新增專輯介紹</h1>
    <asp:Label ID="Label1" runat="server" Text="新增專輯介紹:" style="color:white;"></asp:Label>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
    <br/>
    <asp:FileUpload ID="upload" runat="server" Width="722px" AllowMultiple="True" style="color:white;" />
    <br/>
    <asp:Label ID="Label2" runat="server" Text="新增專輯封面:" style="color:white;"></asp:Label>&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; 
    <br/>
    <asp:FileUpload ID="FileUpload" runat="server" Width="722px" AllowMultiple="True" style="color:white;" />
    <br/>
